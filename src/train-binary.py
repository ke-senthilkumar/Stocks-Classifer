...
train_data_dir = 'c:/temp/sync/data/train/'
validation_data_dir = 'c:/temp/sync/data/validation/'
...
try:
    model.save('c:/temp/sync/Models/WholeModel.h5', overwrite=True)
    model.save_weights('c:/temp/sync/Models/Weights.h5',overwrite=True)
except:
